...
# 1. Inicializa a variável na memória do Streamlit (coloque isso antes do botão)
...
# 2. Quando o botão for clicado, ele altera a memória para True
if st.sidebar.button("Gerar mapa"):
    st.session_state["mostrar_mapa"] = True

# 3. Em vez de checar o botão, checamos a memória
if st.session_state["mostrar_mapa"]:
